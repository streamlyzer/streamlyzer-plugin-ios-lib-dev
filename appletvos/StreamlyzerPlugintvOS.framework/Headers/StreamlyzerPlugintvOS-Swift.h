...
#import <StreamlyzerPlugintvOS/StreamlyzerPlugintvOS.h>
...
SWIFT_MODULE_NAMESPACE_PUSH("StreamlyzerPlugintvOS")

/// @class This class is used to track referred page and current pages
/// It allows you to track page movements on your app.
SWIFT_CLASS("_TtC21StreamlyzerPlugintvOS24STLZPageReferrerObserver")
@interface STLZPageReferrerObserver : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC21StreamlyzerPlugintvOS20STLZPlaybackObserver")
...
SWIFT_CLASS("_TtC21StreamlyzerPlugintvOS25STLZSharedContentObserver")
...
SWIFT_CLASS("_TtC21StreamlyzerPlugintvOS23STLZUserDefinedObserver")
@interface STLZUserDefinedObserver : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC21StreamlyzerPlugintvOS14StreamlyzerLog")
...
SWIFT_CLASS("_TtC21StreamlyzerPlugintvOS17StreamlyzerPlugin")
@interface StreamlyzerPlugin : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_PROTOCOL("_TtP21StreamlyzerPlugintvOS25StreamlyzerPluginDelegate_")
